...
var Auth = function(token){
  ...
  this.authAccessPoints = {
    'inb': ['/inbox', false],
    'tags':['/me/tags', true], 
    'rephist':['/me/reputation-history', true], 
    'rep':['/me/reputation', true], 
    'quest':['/me/questions', true], 
    'posts':['/me/posts', true], 
    'ans':['/me/answers', true], 
    'me':['/me', true]
  };
};
Auth.prototype = Object.create(Emitter.prototype);
    ...
    request({url:query, encoding:null, gzip:true, access_token:this.token}, function(err, resp, body){
      if(err){
        ...
        try {
          ...
          self.emit('completed', self.nextEvent.shift(), body, self);
        } catch(e){
